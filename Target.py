...
## Nessa funcao, pegamos uma entrada, determinamos o comprimento dela, inicializamos uma string para copiar seu conteudo invertido
# conforme percorremos a string original, atribuimos o valor "complementar", entrada[tam-a-1], à copia[a] e retornamos a copia.
